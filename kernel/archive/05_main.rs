...
use arch::aarch64::boot::linker_symbols::_kernel_end; // defined in linker script: required for initializing physical memory allocator
use arch::aarch64::cpu::exceptions::init_exceptions;
use arch::aarch64::mmu::{init_mair, init_tcr, init_ttbr0, enable_mmu, init_page_tables};
use arch::aarch64::gic::gicv2::gicv2;
...
// -----------------------------------------------------------------------------
global_asm!(include_str!("arch/aarch64/boot/start.S"));
global_asm!(include_str!("arch/aarch64/cpu/exception_vectors.S"));  // Let the linker know about the exception vectors (required for interrupts, etc.)
