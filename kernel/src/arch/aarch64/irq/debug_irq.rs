...
pub unsafe fn sgi_irq() {
    ...
    crate::uart_println!("\tGICD_PADDR = 0x{:016x}", gicv2::GICD_PADDR);
    crate::uart_println!("\tGICD_VADDR = 0x{:016x}", gicv2::GICD_VADDR);

    //core::ptr::write_volatile((gicv2::GICD_PADDR + GICD_SGIR) as *mut u32, val);
    core::ptr::write_volatile((gicv2::GICD_VADDR + GICD_SGIR) as *mut u32, val);
